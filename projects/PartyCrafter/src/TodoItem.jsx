...
function TodoItem({ todoItem, onFetchEventTodo, eventId }) {
    ...
    return (
        <Container>
            <Row>
                <Col md={5} className="mb-2 mb-md-0">{todoItem.item_description}</Col>
                ...
                <Col md={1} className="mb-2 mb-md-0">{todoItem.is_done ? 
                    ...
                    <Button onClick={() => onFetchMarkDone(todoItem.item_id)} variant="outline-success">
                        <i className="gg-radio-check"></i>
                    </Button>}
                </Col>
                <Col md={1} className="mb-2 mb-md-0"><Button variant="danger" onClick={() => onFetchDeleteTodo(todoItem.item_id)}><i className="gg-trash"></i></Button></Col>
            </Row>
        </Container>
    )
}
